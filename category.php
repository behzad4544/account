    ...
    <section class="booking">
        ...
        <form action="" method="POST" class="book-form">
            <div class="flex">
                <div class="inputBox">
                    <span>واحد کالا : </span>
                    <input type="text" placeholder="واحد کالا" name="category_product">
                </div>

            </div>

            <input type="submit" value="ثبت دسته بندی" class="btn" name="submit" id="submit">
