...
--
-- Host: localhost:3306
-- Generation Time: Jun 22, 2023 at 08:41 AM
...
(1, '1687421566', 1, 1, 1, 100, 10, 0, 1000, '', 100, '1', '2023-06-22 08:13:05', NULL, 1),
(2, '1687421599', 1, 1, 1, 200, 20, 0, 4000, '', 300, '1', '2023-06-22 08:13:31', NULL, 1);
...
(1, 1, 1000, NULL, 1, NULL, 1000, '1687421566', '2023-06-22 08:13:05', 1),
(2, 2, -1000, NULL, 1, NULL, -1000, '1687421566', '2023-06-22 08:13:05', 1),
(3, 1, 4000, NULL, 2, NULL, 5000, '1687421599', '2023-06-22 08:13:31', 1),
(4, 2, -4000, NULL, 2, NULL, -5000, '1687421599', '2023-06-22 08:13:31', 1),
(5, 1, -2000, NULL, NULL, 1, 3000, '1687421633', '2023-06-22 08:14:07', 1),
(6, 3, 2000, NULL, NULL, 1, 2000, '1687421633', '2023-06-22 08:14:07', 1),
(7, 4, 2000, 1, NULL, NULL, -2000, '1687421660', '2023-06-22 08:14:32', 1),
(8, 1, 2000, 1, NULL, NULL, 1000, '1687421660', '2023-06-22 08:14:32', 1);
...
(19, 'ثبت حواله', './havale.php', 9, 1, '2023-06-19 06:41:10', NULL),
(20, 'ثبت حواله', './havale.php', 9, 2, '2023-06-19 06:41:10', NULL);
...
(2, '2', 'خرید', NULL, NULL, NULL, '1', -5000, '2023-06-20 04:01:50', NULL),
(3, '2', 'فروش', NULL, NULL, NULL, '1', 2000, '2023-06-20 04:01:50', NULL),
(4, '3', 'بانک ملت', 123, '145', NULL, '1', -2000, '2023-06-22 06:35:41', NULL),
...
(1, 1687421633, 1, 1, 100, 20, 0, 2000, '', 200, '1', '2023-06-22 08:14:07', NULL, 1);
...
(1, 1, 1, 200, '2023-06-22 08:13:05', NULL);
...
(1, '1687421660', 4, 1, 2000, '2023-06-22 08:14:32', NULL, 1, '');
...
(1, 'behzad', 'behzad', 'behzad.kermanii@gmail.com', '$2y$10$RcxAXEPlaL33QQ.y0RKTeeNZwFr8uzasX2tRbSpNQ52SPAWqVLCIK', 2, '2', NULL, '2023-06-18 07:16:21', NULL);
...
--
ALTER TABLE `buyfactor`
  MODIFY `buyfactor_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `personaccount`
  MODIFY `cust_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `sellfactors`
  MODIFY `sellfactor_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
